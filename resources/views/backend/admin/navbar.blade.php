...
<nav class="header-nav ms-auto">
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
        ...
        <li class="dropdown-footer">
          <a href="{{ asset('') }}#">Show all notifications</a>
        </li>
    ...
    <li class="nav-item dropdown">
      ...
      <a class="nav-link nav-icon" href="{{ asset('') }}#" data-bs-toggle="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
        <li class="dropdown-header">
          ...
          <a href="{{ asset('') }}#"><span class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
        </li>
        <li>
          <hr class="dropdown-divider">
        </li>
        ...
        <li class="dropdown-footer">
          <a href="{{ asset('') }}#">Show all messages</a>
        </li>
